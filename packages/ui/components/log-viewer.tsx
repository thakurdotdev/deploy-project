...
export function LogViewer({ buildId, initialLogs }: { buildId: string; initialLogs: string }) {
  ...
  return (
    <ScrollArea ref={viewportRef} className="h-[500px] w-full rounded-md border bg-zinc-950 p-4">
